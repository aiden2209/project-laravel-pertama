...
<div class="col-md-4">
  ...
  {{-- Alert Ketika Login Error --}}
   @if(session()->has('loginError'))
  <div class="alert alert-danger alert-dismissible fade show" role="alert" style="border-radius: 10px; border-bottom: solid; border-left: solid">
   ...
   {{-- End Alert --}}
      ...
      <main class="form-login">
        <h1 class="mb-3 fw-normal text-center">Silahkan Login</h1>
      <form action="/login" method="post">
        ...
        {{ $message }}
          ...
          <div class="form-check form-switch" style="margin-left: 330px; margin-bottom:10px">
          ...
          <p class=" bottom-caption">
            Belum Punya Akun?
            <a href="/register">
            <span class="green-bottom-caption">Daftar Disini</span></a>
          </p>
        </div>
        </div>
      </form>
...
@endsection
    ...
    {{-- <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
      style="font-family: 'Poppins', sans-serif">
          ...
          <h4 class="title-text" style="font-size: 21px">Log In Untuk Melanjutkan</h4>
          <p class="caption-text">
            Silahkan login menggunakan akun yang telah<br />
